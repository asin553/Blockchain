...
class PatientRecordContract extends Contract {
    ...
    */
    ...
    //      Pass the Query string built to queryWithQueryString
	  ...
	  let genderqueryResults =  await this.queryWithQueryString(ctx, queryString);
     	  return genderqueryResults;
 }
    ...
    */
    ...
    //      Pass the Query string built to queryWithQueryString
	  ...
	  let blood_typequeryResults =  await this.queryWithQueryString(ctx, queryString);
          return blood_typequeryResults;
    ...
    */
    ...
    //      Pass the Query string built to queryWithQueryString
	  ...
	  let blood_typedualqueryResults =  await this.queryWithQueryString(ctx, queryString);
          return blood_typedualqueryResults;
